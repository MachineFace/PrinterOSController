...
class CreateMessage {
    ...
    get receivedMessage() {
        ...
        let message = '<p>Hi ' + this.name + ',</p>';
            ...
            message += 'If you have questions or need assistance please email ' + staff["Staff"]["link"] + '. <br/>';
    ...
    get completedMessage() {
        ...
        let message = '<p>Hi ' + this.name + ',</p>';
            ...
            message += 'If you have any further questions or need assistance please email ' + staff["Staff"]["link"] + '. <br/>';
    ...
    get shippingQuestion() {
        ...
        let message = '<p>Hi ' + this.name + ',</p>';
            ...
            message += 'If you have any questions or need assistance please email ' + staff["Staff"]["link"] + '. <br/>';
            message += '<p>Best,<br />Jacobs Hall Staff</p>';
        return message;
    }
    get shippedMessage() {
